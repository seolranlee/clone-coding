class Icons {
  ...
  render(isLiked) {
    console.log("****", isLiked);
    const isliked = isLiked ? isLiked : this.isLiked;
    return `
...
class Feed {
    ...
    this.$el
      ...
      .addEventListener("click", () => {
        ...
        this.$el.getElementsByClassName(
          "feed__icons"
        )[0].innerHTML = this.icons.render(this.isLiked);
  ...
  render(el) {
    ...
    <div class="feed__icons">${this.icons.render()}</div>
